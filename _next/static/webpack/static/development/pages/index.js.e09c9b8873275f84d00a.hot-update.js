...
})(["width:100%;display:grid;grid-template-columns:repeat(2,1fr);grid-template-rows:repeat(2,1fr);grid-row-gap:2rem;grid-column-gap:4rem;@media ", "{background-color:green;grid-row-gap:1rem;grid-column-gap:1rem;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptopL);
...
//# sourceMappingURL=index.js.e09c9b8873275f84d00a.hot-update.js.map