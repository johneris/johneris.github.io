...
})(["margin-top:2rem;display:grid;grid-template-columns:1fr auto;grid-template-rows:auto;grid-column-gap:15%;@media ", "{background-color:grey;display:flex;flex-direction:column-reverse;}@media ", "{background-color:green;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptopL, _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptop);
...
})(["display:flex;flex-direction:column;@media ", "{display:grid;grid-template-columns:repeat(2,1fr);grid-template-rows:repeat(2,1fr);}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptopL);
...
//# sourceMappingURL=index.js.e33fb9f633c004961351.hot-update.js.map