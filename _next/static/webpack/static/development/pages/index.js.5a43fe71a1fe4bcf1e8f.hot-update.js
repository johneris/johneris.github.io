...
})(["width:70%;display:flex;flex-direction:column;justify-content:flex-end;align-items:flex-end;"]);
...
})(["font-size:2em;text-align:center;@media ", "{font-size:1.5em;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanTablet);
...
})(["margin-top:1.5rem;color:#A7ADB1;font-size:1.5em;font-style:italic;@media ", "{font-size:1em;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanTablet);
class QuotationSection extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  render() {
    ...
    }, "Change - real change - comes from the inside out."), "\xA0It doesn't come from hacking at the leaves of attitude and behavior with quick fix personality ethic techniques. \xA0", __jsx("span", {
      style: {
        color: '#23A155'
      },
      __self: this,
    ...
    }, "It comes from striking at the root"), "\xA0- the fabric of our thought, the fundamental, essential paradigms, \xA0", __jsx("span", {
      style: {
        color: '#23A155'
      },
      __self: this,
    ...
    }, "which we give definition to our character"), "\xA0and create the lens through \xA0", __jsx("span", {
      style: {
        color: '#23A155'
      },
      __self: this,
    ...
    }, "which we see the world"), "."), __jsx(Author, {
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 60,
...
//# sourceMappingURL=index.js.5a43fe71a1fe4bcf1e8f.hot-update.js.map