...
})(["margin-top:2rem;display:grid;grid-template-columns:1fr auto;grid-template-rows:auto;grid-column-gap:15%;@media ", "{display:flex;flex-direction:column-reverse;}@media ", "{background-color:green;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptopL, _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptop);
...
})(["display:flex;flex-direction:column;@media ", "{flex-direction:row;}@media ", "{flex-wrap:wrap;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptopL, _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptop);
...
})(["margin-bottom:1.5rem;@media ", "{margin-right:1rem;margin-bottom:2rem;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptopL);
...
//# sourceMappingURL=index.js.b200f010c9179a9cc385.hot-update.js.map