...
})(["width:100%;display:grid;grid-template-columns:repeat(2,1fr);grid-template-rows:repeat(2,1fr);grid-row-gap:2rem;grid-column-gap:4rem;@media ", "{grid-template-columns:100%;grid-template-rows:repeat(4,1fr);grid-row-gap:1rem;grid-column-gap:0;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptop);
...
//# sourceMappingURL=index.js.36d318fbd70b38b9f482.hot-update.js.map