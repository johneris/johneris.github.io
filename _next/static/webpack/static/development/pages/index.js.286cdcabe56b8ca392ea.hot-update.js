...
})(["width:calc(80% + (0.9rem * 2));height:100%;margin-left:auto;margin-right:auto;display:grid;grid-template-columns:repeat(3,0.9rem) 25.5rem 0.9rem auto 0.9rem;grid-template-rows:1fr;@media ", "{grid-template-columns:100%;grid-template-rows:repeat(2,1fr);}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptopL);
...
})(["margin-top:2rem;display:grid;grid-template-columns:repeat(3,1fr);grid-template-rows:1fr;grid-column-gap:1.5rem;@media ", "{grid-column-gap:1rem;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanTablet);
...
//# sourceMappingURL=index.js.286cdcabe56b8ca392ea.hot-update.js.map