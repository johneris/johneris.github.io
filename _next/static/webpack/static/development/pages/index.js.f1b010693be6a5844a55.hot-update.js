...
})(["width:calc(80% + (0.9rem * 2));height:100%;margin-left:auto;margin-right:auto;display:grid;grid-template-columns:repeat(3,0.9rem) 25.5rem 0.9rem auto 0.9rem;grid-template-rows:1fr;@media ", "{grid-template-columns:100%;grid-template-rows:auto auto;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptopL);
...
})(["padding:4rem 2rem;display:flex;flex-direction:column;justify-content:center;align-items:center;"]);
...
})(["margin-top:2rem;display:grid;grid-template-columns:repeat(3,1fr);grid-template-rows:1fr;grid-column-gap:1.5rem;@media ", "{grid-template-columns:repeat(3,10px);grid-column-gap:1rem;}"], _helpers_MediaQueryHelper__WEBPACK_IMPORTED_MODULE_2__["device"].lowerThanLaptopL);
...
//# sourceMappingURL=index.js.f1b010693be6a5844a55.hot-update.js.map