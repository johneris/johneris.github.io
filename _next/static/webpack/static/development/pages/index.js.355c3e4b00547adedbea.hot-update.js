  ...
  constructor(props) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "state", {
      projects: [{
        ...
        vendor: 'Developed at Coreproc, Inc.',
        description: 'MyPocketDoctor is a medical advisory app, that provides you with fast access to doctors (telemedicine). The doctors are all fully licensed European doctors. There are many cases where you might need fast medical advise: When traveling, unable to communicate with staff in foreign clinics, not sure if you need to go to the emergency ward or go to see your own doctor (avoid the waiting time and travel involved) etc. etc.',
        involvementDescription: 'Involvement: from start to production and maintenace',
        involvementDate: 'Date: while still at Coreproc, Inc.',
        features: ['', '', '', ''],
        platforms: [{
...
//# sourceMappingURL=index.js.355c3e4b00547adedbea.hot-update.js.map